...
SmallVector<Metadata *, 4> LoopInfo::createMetadata(
  ...
  // Setting FTM loop iteration counts.
  if (Attrs.FTMMinIterations > 0) {
    Metadata *Vals[] = {MDString::get(Ctx, "llvm.loop.ftm.min_iterations"),
                        ConstantAsMetadata::get(ConstantInt::get(
                            llvm::Type::getInt64Ty(Ctx), Attrs.FTMMinIterations))};
    LoopProperties.push_back(MDNode::get(Ctx, Vals));
  }
  if (Attrs.FTMMaxIterations > 0) {
    Metadata *Vals[] = {MDString::get(Ctx, "llvm.loop.ftm.max_iterations"),
                        ConstantAsMetadata::get(ConstantInt::get(
                            llvm::Type::getInt64Ty(Ctx), Attrs.FTMMaxIterations))};
    LoopProperties.push_back(MDNode::get(Ctx, Vals));
  }
...
LoopAttributes::LoopAttributes(bool IsParallel)
    : IsParallel(IsParallel), VectorizeEnable(LoopAttributes::Unspecified),
      ...
      FTMMinIterations(0), FTMMaxIterations(0) {}
...
LoopInfo::LoopInfo(BasicBlock *Header, const LoopAttributes &Attrs,
  ...
  if (!Attrs.IsParallel && Attrs.VectorizeWidth == 0 &&
      ...
      Attrs.FTMMinIterations == 0 && Attrs.FTMMaxIterations == 0)
    return;
...
void LoopInfoStack::push(BasicBlock *Header, clang::ASTContext &Ctx,
  ...
  for (const auto *Attr : Attrs) {
    ...
    case LoopHintAttr::Disable:
      ...
      case LoopHintAttr::FTMMinIterations:
      case LoopHintAttr::FTMMaxIterations:
    ...
    case LoopHintAttr::Numeric:
      ...
      case LoopHintAttr::PipelineInitiationInterval:
        ...
        break;
      case LoopHintAttr::FTMMinIterations:
        setFTMMinIterations(ValueInt);
        break;
      case LoopHintAttr::FTMMaxIterations:
        setFTMMaxIterations(ValueInt);
        break;
      case LoopHintAttr::Unroll:
      case LoopHintAttr::UnrollAndJam:
      case LoopHintAttr::VectorizePredicate:
