...
struct LoopAttributes {
  ...
  /// Value for llvm.loop.ftm.min_iterations metadata.
  unsigned FTMMinIterations;

  /// Value for llvm.loop.ftm.max_iterations metadata.
  unsigned FTMMaxIterations;
};
...
public:
  ...
  /// Set the FTM min iterations for the next loop pushed.
  void setFTMMinIterations(unsigned C) { StagedAttrs.FTMMinIterations = C; }

  /// Set the FTM max iterations for the next loop pushed.
  void setFTMMaxIterations(unsigned C) { StagedAttrs.FTMMaxIterations = C; }
